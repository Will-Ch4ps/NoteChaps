...
import { clampDiagramHeight, clampDiagramWidth, stripDiagramLayoutMeta } from '../../../../shared/diagramLayout'
...
export function DiagramPanel() {
  ...
  const handleApply = () => {
    ...
    const width = clampDiagramWidth(activeDiagram.width)
    const height = clampDiagramHeight(activeDiagram.height)
